...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Invoice List | Madina Mall Admin</title>
                                            ...
                                            <table class="table table-centered table-nowrap table-borderless table-hover mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><a href="#" class="text-gray-800 text-hover-primary mb-1">INV-1234</a></td>
													<td>
													<div class="d-flex flex-column">
																	<a href="#" class="text-gray-800 text-hover-primary mb-1">Emma Smith</a>
																	<span>+92-612-123-4567</span>
																</div>
													</td>
													<!--end::Name=-->
													<!--begin::Company=-->
													...
													<td><div class="badge bg-primary mb-1">#C-13</div></td>
													<!--end::Payment method=-->
													<!--begin::Date=-->
													<td><span class="fw-bolder">$800</span></td>
													<td>14 Dec 2021</td>
													<td>22 Dec 2021</td>
													<td><div class="badge bg-danger">Un-Paid</div></td>
